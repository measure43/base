                            ...
                            if data:
                                ...
                                # If received message is service message. Then parse and process it w/o broadcasting.
                                    ...
                                    if msg_dict['body'] == 1:
                                        ...
                                        continue
                                    # If received message is a "kill server" service message.
                                    elif msg_dict['body'] == 9:
                                        logging.info("Shutdown server command received; Going down")
                                        break
                                    else:
                                        logging.info("Unknown command received from %s:%d", client_address[0], client_address[1])
                            ...
                            struct_msg = json.dumps(\
                                {
                                    ...
                                    'username': self.username,
                                    'msgtype': 'ursmsg',
                                    'body': "\rClient [{0}, {1}] has gone offline".format(client_address[0], client_address[1])
                                })
